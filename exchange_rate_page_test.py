...
def test_conversion_rate(driver):
    ...
    WebDriverWait(driver, 10).until(EC.text_to_be_present_in_element(conversion_rate, "Conversion Rate: 9.97340425531915"))
    assert driver.find_element(*conversion_rate).text == "Conversion Rate: 9.97340425531915"
